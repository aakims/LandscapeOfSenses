...
, timeField = ["ftime"]
, dataFields = ["trip", "olive", "ftime", "dust", "light", "tempF", "GINI_IND"]
, locationFields = ["FIPS", ];
...
var displayGraphs = function () {
            ...
            .each(function (sensObj) {return ((senseObj.properties[dataFields[thisIndex]]) ? 
                ...
                sensObj.properties_.each(selectData, function (propName) {sensObj.properties[propName] = +sensObj.properties[propName];});})

return _.map(thisData, function(sensObj) {return _.pick(sensObj.properties, "ftime", yData)});
            ...
            var mapGraphData; 
            _.each(selectData, createVisualization); 
